    ...
    return (
        <div className="container">
            <div className="pricing_top">
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cum vitae minus esse aliquid magni, aspernatur molestias odit quidem expedita suscipit, tenetur voluptate aut hic consequuntur quia excepturi, quam ducimus modi!</p>
            </div>
                ...
                {pricing_data.map((pricing_item, index) =>
                    <div className="pricing_item" key={index}>
                        ...
                        <div className="services">
                            ...
                            <button className='register_btn'></button>
                        </div>
                    </div>
                )}
            </div>
